<?php
/**
* MoisDuDoc Plugin  - Joomla 4 Task Plugin 
* Version			: 1.0.0
...
class plgtaskMoisDuDocInstallerScript
{
	private $min_joomla_version      = '4.1.0';
	private $min_php_version         = '7.2';
	private $name                    = 'Plugin MoisDuDoc';
	private $exttype                 = 'plugin';
	private $extname                 = 'moisdudoc';
	private $previous_version        = '';
	private $dir           = null;
	private $installerName = 'plgtaskmoisdudocinstaller';
	...
	private function postinstall_cleanup() {
        ...
        $conditions = array(
            ...
            $db->qn('element') . ' = ' . $db->quote('moisdudoc')
        );
        ...
        try {
            ...
            JLog::add('unable to enable plugin MoisDuDoc', JLog::ERROR, 'jerror');
        }
